        ...
        <div class="right">
            <div class="top_search">
                ...
                <div class="input-group"> 
                   ...
                   <label class="control-label satisfy" style="">Call us now! (+91)8798908789</label>
            ...
            <div class="collapse navbar-collapse navbar-light" id="collapsenav"> 
                <ul class="navbar-nav"> 
                    ...
                    <li class="nav-item"> 
                        <a class="nav-link" href="#">Dating Blog</a> 
                    </li> 
                  
                    <li class="nav-item"> 
                        <a class="nav-link" href="#">Who We Helped</a> 
                    </li> 
                    <li class="nav-item"> 
                        <a class="nav-link" href="#">Why Vital</a> 
                    </li> 
                    <li class="nav-item"> 
